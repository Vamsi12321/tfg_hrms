...
// GET /hrms/work/work-items/dashboard
export async function getWorkItemsDashboard(params = {}) {
  return request("GET", "/hrms/work/work-items/dashboard", null, params);
}
...
export async function getDashboard(params = {}) {
  return request("GET", "/hrms/dashboard/", null, params);
}
...
export async function createTeam(data) {
  return request("POST", "/hrms/teams/", data);
}

export async function listTeams(params = {}) {
  return request("GET", "/hrms/teams/", null, params);
}

export async function getTeamDetail(teamId) {
  return request("GET", `/hrms/teams/${teamId}`);
}

export async function updateTeam(teamId, data) {
  return request("PUT", `/hrms/teams/${teamId}`, data);
}

export async function deleteTeam(teamId) {
  return request("DELETE", `/hrms/teams/${teamId}`);
}
