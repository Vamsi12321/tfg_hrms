...
export async function markNotificationRead(notificationId) {
  return request("PATCH", `/hrms/notifications/${notificationId}/read`);
}

export async function markAllNotificationsRead() {
  return request("PATCH", "/hrms/notifications/read-all");
}
...
export async function getPayrollConfig(params = {}) {
  return request("GET", "/hrms/payroll/config", null, params);
}

export async function updatePayrollConfig(data, params = {}) {
  return request("PUT", "/hrms/payroll/config", data, params);
}
